...
export default function FAQ() {
  ...
  return (
    <section className="bg-background mt-16 lg:mt-28">
      <div className="container mx-auto max-w-6xl px-4 md:px-6">
        <div className="mb-12 flex flex-col items-center">
           <div className="inline-flex items-center gap-2 mb-4 rounded-full border border-border bg-muted/50 px-3 py-1 text-sm">
            <div className="h-1.5 w-1.5 rounded-full bg-green-500" />
            <span className="text-muted-foreground">FAQs</span>
          </div>
          <h2 className="text-foreground mb-6 text-center text-2xl font-bold tracking-tight md:text-4xl">
