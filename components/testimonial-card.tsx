...
export const ClientsSection = ({
  ...
  return (
    <section className={cn("w-full bg-background text-foreground", className)}>
      <div className="container px-4 lg:px-0 mx-auto md:grid grid-cols-2 gap-12 lg:gap-20 items-start">
        {/* Left Column: Sticky Content */}
        <div className="flex flex-col mx-auto gap-6 lg:sticky lg:top-20">
